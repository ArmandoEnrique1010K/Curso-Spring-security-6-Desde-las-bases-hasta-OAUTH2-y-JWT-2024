...
public class MyAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (passwordEncoder.matches(pwd, customerPwd)) {
            ...
            final var roles = customer.getRoles(); // Obtiene los roles del usuario desde la base de datos.

            // Convierte los roles del usuario en un listado de autoridades (roles que serán
            // usados para controlar el acceso).
