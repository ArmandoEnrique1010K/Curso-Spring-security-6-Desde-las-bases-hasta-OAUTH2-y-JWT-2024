...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        // Se agrega un filtro personalizado para validar la clave API antes del filtro
        // de autenticación básica.
        // El ApiKeyFilter es ejecutado antes de BasicAuthenticationFilter para asegurar
        // que
        // la clave API es verificada antes de proceder con la autenticación estándar.
